                        ...
                        if ($resultado->num_rows > 0){
                            ...
                            while ($linha = $resultado->fetch_assoc()){
                                echo '<tr>
                                        ...
                                        <td class="tdInfo" nowrap="nowrap" align="center">'.$linha['prd_descricao'].'</td>
                                        ...
                                        <td class="tdInfo"><a style="font-size: 28px; text-decoration: none; color: gray;" href="../../controller/excluir_produto.php?id='.$linha['prd_id'].'&url'.$_SERVER['REQUEST_URI'].'">&times;</a></td>
                                    </tr>';
                            }
                        }else{
